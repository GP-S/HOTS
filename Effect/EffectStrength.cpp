...
EffectStrength::EffectStrength(){//complete this
...
void EffectStrength::increaseStrength(Card* card,unsigned int modifier){
...
void EffectStrength::decreaseStrength(Card* card,unsigned int modifier){
...
void EffectStrength::increaseBaseStrength(Card* card,unsigned int modifier){
...
void EffectStrength::decreaseBaseStrength(Card* card,unsigned int modifier){
